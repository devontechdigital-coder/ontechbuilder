...
@Module({
  ...
  providers: [configProvider, PrismaService, ObjectStorageService, ObjectStorageHealthService, MailerService],
  exports: [configProvider, PrismaService, ObjectStorageService, ObjectStorageHealthService, MailerService],
})
